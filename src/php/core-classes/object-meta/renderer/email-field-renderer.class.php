 ...
 */
class CUAR_EmailFieldRenderer extends CUAR_AbstractInputFieldRenderer implements CUAR_FieldRenderer {

	public function __construct( $label, $readonly = false, $inline_help='' ) {
		parent::__construct( 'email', $label, $readonly, $inline_help );
	}
