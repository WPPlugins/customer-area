...
if (!class_exists('CUAR_PostMetaStorage')) :

include_once( CUAR_INCLUDES_DIR . '/core-classes/object-meta/storage/storage.interface.php' );

/**
 * An implementation to store info as post meta
*
* @author Vincent Prat @ MarvinLabs
*/
class CUAR_PostMetaStorage implements CUAR_Storage {
...
endif; // if (!class_exists('CUAR_PostMetaStorage')) :