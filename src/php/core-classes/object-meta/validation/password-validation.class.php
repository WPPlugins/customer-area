...
if (!class_exists('CUAR_PasswordValidation')) :
...
*/
class CUAR_PasswordValidation extends CUAR_SimpleValidation implements CUAR_ValidationRule {
...
endif; // if (!class_exists('CUAR_PasswordValidation')) :